...
def clean(client):
    ...
    print(f"  ✓ {len(edges)} edges removed")

    # Nodes
    nodes = client.get_all("/nodes/")
    for n in nodes:
        client.delete(f"/nodes/{n['id']}")
    print(f"  ✓ {len(nodes)} nodes removed")
    ...
    for path in ["/node-property-definitions/", "/edge-property-definitions/"]:
        ...
        for item in items:
            client.delete(f"{path}{item['id']}")
    print(f"  ✓ Property definitions removed")
    ...
    print(f"  ✓ Node/edge types removed")
...
def seed(client):
    ...
    print(f"  ✓ {len(pd)} property definitions created")
    ...
    print(f"  ✓ Properties assigned to all node types")
    ...
    print(f"  ✓ {len(arch)} architecture elements created")
    ...
    print(f"  ✓ {len(req)} safety requirements created")
    ...
    print(f"  ✓ {len(haz)} hazards created")
    ...
    print(f"  ✓ {len(ctrl)} controls created")
    ...
    print(f"  ✓ {len(gsn)} GSN nodes created")
    ...
    print(f"  ✓ {len(ev)} evidence items created")
